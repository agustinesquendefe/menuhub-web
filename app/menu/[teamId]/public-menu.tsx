...
function ProductCard({
  ...
  return (
    <div
      className="flex gap-4 py-4 border-b last:border-0 cursor-pointer group"
...
function MenuContent({ team, categories, policies }: PublicMenuProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-6 pb-28">
        {/* Policy warnings */}
      ...
      {/* Footer público con info del restaurante */}
        ...
        <div className="max-w-2xl mx-auto flex flex-col items-center text-center gap-3">
          {team.logoUrl && (
            <img
              ...
              style={{ background: '#f9fafb', borderRadius: 12, padding: 8 }}
            />
          )}
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-1">
            {team.contactPhone && (
              <span className="text-sm text-gray-500 flex items-center gap-1">
                <span role="img" aria-label="Teléfono">📞</span> {team.contactPhone}
              </span>
            )}
            {team.contactEmail && (
              <span className="text-sm text-gray-500 flex items-center gap-1">
                <span role="img" aria-label="Email">✉️</span> {team.contactEmail}
              </span>
            )}
          </div>
        </div>
